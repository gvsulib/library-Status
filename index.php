...
<div class="cms-clear"></div>
	...
	<div class="alert alert-success" style="margin: 0;"> Welcome to the new Status App!  We are migrating data from the old app over as quickly as we can.  If you experience problems or bugs, email felkerk@gvsu.edu and our app developer will get right on it.  The old status app can be accessed at: <a href="http://prod.library.gvsu.edu/oldstatus">http://prod.library.gvsu.edu/oldstatus</A></div>'
